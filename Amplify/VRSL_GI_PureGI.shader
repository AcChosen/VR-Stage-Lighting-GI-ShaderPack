...
Shader "VRSL_GI_PureGI"
{
	...
	LOD 100
		...
		Pass
		{
			...
			float3 GetEyeVector59_g14( float3 n )
			{
			...
			float3 GetGI24_g14( int lightCount, float3 worldNormal, float3 viewDirection, float3 worldPos, float occlusion, float roughness, float metallic, float3 diffuseColor, float4 shadowmask1, float4 shadowmask2, float4 shadowmask3, float specularMultiply, float overallStrength )
			{
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				#endif
				int localGetLightCount23_g14 = GetLightCount23_g14();
				int lightCount24_g14 = localGetLightCount23_g14;
				float3 ase_worldNormal = i.ase_texcoord1.xyz;
				float3 normalizedWorldNormal = normalize( ase_worldNormal );
				float3 worldNormal24_g14 = normalizedWorldNormal;
				float3 temp_output_1_0_g14 = WorldPosition;
				float3 n59_g14 = ( temp_output_1_0_g14 - _WorldSpaceCameraPos );
				float3 localGetEyeVector59_g14 = GetEyeVector59_g14( n59_g14 );
				float3 normalizeResult10_g14 = normalize( ( localGetEyeVector59_g14 * float3( -1,-1,-1 ) ) );
				float3 viewDirection24_g14 = normalizeResult10_g14;
				float3 worldPos24_g14 = temp_output_1_0_g14;
				float localGetData32_g14 = ( 0.0 );
				GetData(  );
				float occlusion24_g14 = ( localGetData32_g14 + 1.0 );
				float roughness24_g14 = _Roughness;
				float metallic24_g14 = _Metallic;
				float3 diffuseColor24_g14 = _AlbedoColor.rgb;
				float4 color89_g14 = IsGammaSpace() ? float4(1,1,1,1) : float4(1,1,1,1);
				#if defined(_VRSLGISHADOWMASKUV_UV0)
				float2 staticSwitch72_g14 = i.ase_texcoord2.xy;
				#elif defined(_VRSLGISHADOWMASKUV_UV1)
				float2 staticSwitch72_g14 = i.ase_texcoord2.zw;
				#elif defined(_VRSLGISHADOWMASKUV_UV2)
				float2 staticSwitch72_g14 = i.ase_texcoord3.xy;
				#elif defined(_VRSLGISHADOWMASKUV_UV3)
				float2 staticSwitch72_g14 = i.ase_texcoord3.zw;
				#elif defined(_VRSLGISHADOWMASKUV_UV4)
				float2 staticSwitch72_g14 = i.ase_texcoord4.xy;
				#else
				float2 staticSwitch72_g14 = i.ase_texcoord2.xy;
				#endif
				#ifdef _VRSLGISHADOWMASK1_ON
				float4 staticSwitch87_g14 = tex2D( _VRSLShadowMask1, staticSwitch72_g14 );
				#else
				float4 staticSwitch87_g14 = color89_g14;
				#endif
				float4 shadowmask124_g14 = staticSwitch87_g14;
				#ifdef _VRSLGISHADOWMASK2_ON
				float4 staticSwitch90_g14 = tex2D( _VRSLShadowMask2, staticSwitch72_g14 );
				#else
				float4 staticSwitch90_g14 = color89_g14;
				#endif
				float4 shadowmask224_g14 = staticSwitch90_g14;
				#ifdef _VRSLGISHADOWMASK3_ON
				float4 staticSwitch92_g14 = tex2D( _VRSLShadowMask3, staticSwitch72_g14 );
				#else
				float4 staticSwitch92_g14 = color89_g14;
				#endif
				float4 shadowmask324_g14 = staticSwitch92_g14;
				float specularMultiply24_g14 = _GISpecularStrength;
				float overallStrength24_g14 = _VRSLGIStrength;
				float3 localGetGI24_g14 = GetGI24_g14( lightCount24_g14 , worldNormal24_g14 , viewDirection24_g14 , worldPos24_g14 , occlusion24_g14 , roughness24_g14 , metallic24_g14 , diffuseColor24_g14 , shadowmask124_g14 , shadowmask224_g14 , shadowmask324_g14 , specularMultiply24_g14 , overallStrength24_g14 );
				
				
				finalColor = float4( localGetGI24_g14 , 0.0 );
				return finalColor;
			}
			ENDCG
		}
...
Node;AmplifyShaderEditor.FunctionNode;162;-464.2018,-103.2101;Inherit;False;VRSL_GI_Function_GetGI;0;;14;8094ff91e0e2ed145978a14e00a9083d;0;6;119;FLOAT;0;False;120;FLOAT;0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;5;FLOAT3;1,1,1;False;8;FLOAT;1;False;1;FLOAT3;0
...
WireConnection;162;119;108;0
WireConnection;162;120;107;0
WireConnection;162;5;95;0
WireConnection;2;0;162;0
ASEEND*/
//CHKSM=853E464BC892C2C88CA40FF156A82BCEF36C98BD